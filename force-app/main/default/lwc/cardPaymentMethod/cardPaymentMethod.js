...
const cardTypesObj = {
    Visa: cardLabels.Visa,
    'Master Card': cardLabels.MasterCard,
    'American Express': cardLabels.AmericanExpress,
    'Diners Club': cardLabels.DinersClub,
    Jcb: cardLabels.JCB
};
    ...
    hasIncompleteCardPaymentFields() {
        ...
        const isInvalidField = fieldRequiredValueMap.find((field) => {
            if (!field.isHiddenAttr && field.isRequiredAttr && !field.value) {
                this.creditCardErrorMessage = field.error;
                return true;
            }
            return false;
        });
