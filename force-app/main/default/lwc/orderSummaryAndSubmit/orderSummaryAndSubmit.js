...
export default class OrderSummaryAndSubmit extends LightningElement {
    @api recordId;
    @api webstoreId;
    @api searchResultFields;
    @api generatedCartId;
    @api searchResultFieldsLabel;
    @api cartGroupDelivery;
    @api cartDeliveryMethod;
    ...
    connectedCallback(){
        ...
        console.log(JSON.stringify(this.cartDeliveryMethod));
        console.log(JSON.stringify(this.cartGroupDelivery));
    }
